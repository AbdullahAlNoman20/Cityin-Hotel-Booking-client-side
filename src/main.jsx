        ...
        children: [
          {
            ...
            loader: () => fetch('https://edu-bd-server.vercel.app/users')
          },
          {
            path: "courses",
          ...
          },
          {
            ...
            loader: () => fetch('https://edu-bd-server.vercel.app/studyMaterial')
          },
        ]
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loader: () => fetch('https://edu-bd-server.vercel.app/sessions')
          },
          {
          ...
          },
          {
            path: "notes",
            element: <Notes></Notes>,
            loader: () => fetch('https://edu-bd-server.vercel.app/nots')
          },
        ]
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loader: ({params}) => fetch(`https://edu-bd-server.vercel.app/nots/${params.id}`)
          },
          {
            path: "materials",
